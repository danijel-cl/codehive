                  ...
                  <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-lg-4 col-md-4 col-xs-6">
                        <div className="mb-8">
                          <p className="font-size-4">Company size</p>
                          <h5 className="font-size-4 font-weight-semibold">11-50 employees</h5>
                        </div>
                        <div className="mb-8">
                          <p className="font-size-4">Est. Since</p>
                      ...
                      <div className="col-12 col-lg-4 col-md-4 col-xs-6">
                        <div className="mb-8">
                          <p className="font-size-4">Type of corporation</p>
                          <h5 className="font-size-4 font-weight-semibold">B2B &amp; B2C</h5>
                        </div>
                        <div className="mb-8">
                          <p className="font-size-4">Social Media</p>
                          <div className="icon-link d-flex align-items-center">
                            <a className="text-smoke circle-32 bg-concrete mr-5" href="#">
                      ...
                      <div className="col-12 col-lg-4 col-md-4 col-xs-6">
                        <div className="mb-8">
                          <p className="font-size-4">Location</p>
                          <h5 className="font-size-4 font-weight-semibold">New York City</h5>
                        </div>
                      </div>
                      {/* Single Widgets End */}
                    </div>
                ...
                <ul className="list-unstyled">
                  ...
                  <li className="border-bottom">
                    <a className="media align-items-center py-9" href="#">
                      ...
                      <div className="mt-n4">
                        <h4 className="mb-0 font-size-6 font-weight-semibold">Google INC.</h4>
                  ...
                  <li className="border-bottom">
                    <a className="media align-items-center py-9" href="#">
                      ...
                      <div className="mt-n4">
                        <h4 className="mb-0 font-size-6 font-weight-semibold">Uber</h4>
