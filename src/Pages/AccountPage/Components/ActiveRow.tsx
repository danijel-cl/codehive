    ...
    <tr className="border border-color-2">
      <th scope="row" className="pl-6 border-0 py-7 pr-0">
        <a href="candidate-profile.html" className="media min-width-px-235 align-items-center">
          ...
          <h4 className="font-size-4 mb-0 font-weight-semibold text-black-2">Google</h4>
        </a>
      </th>
      ...
      <td className="table-y-middle py-7 min-width-px-170 pr-0">
        <div><Link to="/posts/:id/tasks/" className="font-size-3 font-weight-bold text-uppercase">View</Link></div>
      </td>
    </tr>
  );
};
