  ...
  return (
    <div className="dashboard-sidebar-wrapper" style={{ paddingTop:"10vh"}}>
      ...
      <ul className="list-unstyled dashboard-layout-sidebar pt-15">
        ...
        <li style={{cursor: 'pointer'}} onClick={()=>props.setPage(1)} className={(props.page === 1 ? "active" : "")}><a className="px-10 py-1 my-5 font-size-4 font-weight-semibold flex-y-center"><i className="fas fa-user mr-7" />Finished Challanges</a></li>
        <li style={{cursor: 'pointer'}} onClick={()=>props.setPage(2)} className={(props.page === 2 ? "active" : "")}><a className="px-10 py-1 my-5 font-size-4 font-weight-semibold flex-y-center"><i className="fas fa-clock mr-7" />Task Submissions</a></li>
        <li style={{cursor: 'pointer'}} onClick={()=>props.setPage(3)} className={(props.page === 3 ? "active" : "")}><a className="px-10 py-1 my-5 font-size-4 font-weight-semibold flex-y-center"><i className="icon icon-layout-11 mr-7" />Statistics</a></li>
